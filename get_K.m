...
a11=polyfit(leg,k11,3);%polyfit 最小二乘拟合函数
...
x0=leg;              %步长为0.1
y11=polyval(a11,x0);          %返回值y0是对应于x0的函数值 得到polyfit拟合后函数值
...
fprintf('float K11[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a11(1),a11(2),a11(3),a11(4));
fprintf('float K12[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a12(1),a12(2),a12(3),a12(4));
fprintf('float K13[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a13(1),a13(2),a13(3),a13(4));
fprintf('float K14[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a14(1),a14(2),a14(3),a14(4));
fprintf('float K15[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a15(1),a15(2),a15(3),a15(4));
fprintf('float K16[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a16(1),a16(2),a16(3),a16(4));

fprintf('float K21[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a21(1),a21(2),a21(3),a21(4));
fprintf('float K22[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a22(1),a22(2),a22(3),a22(4));
fprintf('float K23[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a23(1),a23(2),a23(3),a23(4));
fprintf('float K24[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a24(1),a24(2),a24(3),a24(4));
fprintf('float K25[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a25(1),a25(2),a25(3),a25(4));
fprintf('float K26[6] = {0,%.6ff,%.6ff,%.6ff,%.6ff};\n',a26(1),a26(2),a26(3),a26(4));
toc
