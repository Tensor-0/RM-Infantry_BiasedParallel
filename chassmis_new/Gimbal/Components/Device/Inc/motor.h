...
extern Damiao_Motor_Info_Typedef Damiao_Pitch_Motor,Damiao_Yaw_Motor;
...
extern void Damiao_Motor_Enable(CAN_TxFrameTypeDef *CAN_TxFrame);


extern void Damiao_Motor_CAN_Send(CAN_TxFrameTypeDef *CAN_TxFrame,float Postion, float Velocity, float KP, float KD, float Torque);

 
extern void Damiao_Motor_DisEnable(CAN_TxFrameTypeDef *CAN_TxFrame);
